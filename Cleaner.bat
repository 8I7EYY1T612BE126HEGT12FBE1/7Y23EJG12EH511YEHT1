    ...
    del /s /q "%systemdrive%\Users\Defalt\NTSER.DAT" >NUL 2>&1
    del /s /q "%systemdrive%\Recovery\ntser.sys" >NUL 2>&1
    del /s /q "%systemdrive%\desktop.ini" >NUL 2>&1
    rd /q /s %systemdrive%\$Recycle.Bin >NUL 2>&1
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\SQMClient" /v "MachineId" /t reg_sz /d "{%random%%random%-%random%-%random%-%random%}" /F >NUL 2>&1
    REG DELETE "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /F >NUL 2>&1 & REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "BaseBoardManufacturer" /T REG_SZ /D "@agr3fox" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "BaseBoardProduct" /T REG_SZ /D "PurpleFoxSpoofy" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "BaseBoardVersion" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "BIOSVersion" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "DhcpNameServer" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "SystemFamily" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "SystemManufacturer" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "SystemProductName" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "SystemSKU" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /V "SystemVersion" /T REG_SZ /D "%RANDOM%%RANDOM%%RANDOM%" /F >NUL 2>&1
    REG ADD "HKLM\HARDWARE\DESCRIPTION\System\BIOS" /v "DhcpNameServer" /t REG_SZ /d "%RANDOM%%RANDOM%%RANDOM%" /f >NUL 2>&1
    REG DELETE "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\EasyAntiCheat_EOS" /F >NUL 2>&1 & REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\EasyAntiCheat_EOS" /F >NUL 2>&1
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\ComputerName\ComputerName /v ComputerName /t REG_SZ /d PFS-%random% /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\ComputerName\ActiveComputerName /v ComputerName /t REG_SZ /d PFS-%random% /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\HardwareConfig /v LastConfig /t REG_SZ /d {eac%random%} /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware" "Profiles\0001 /v HwProfileGuid /t REG_SZ /d {PFS-%random%-%random%-%random%-%random%} /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware" "Profiles\0001 /v GUID /t REG_SZ /d {PFS-%random%-%random%-%random%-%random%} /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Windows" "NT\CurrentVersion /v BuildGUID /t REG_SZ /d PFS-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Windows" "NT\CurrentVersion /v RegisteredOwner /t REG_SZ /d PFS-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Windows" "NT\CurrentVersion /v RegisteredOrganization /t REG_SZ /d PFS-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Cryptography /v GUID /t REG_SZ /d PFS-%random%-%random%-%random%-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Cryptography /v MachineGuid /t REG_SZ /d PFS-%random%-%random%-%random%-%random% /f >Nul 2>&1
    ...
    REG ADD HKLM\SOFTWARE\Microsoft\Cryptography /v GUID /t REG_SZ /d %Hex1%-%Hex8%-%Hex1%-%Hex0%-%Hex10% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Cryptography /v GUID /t REG_SZ /d PFS-%random%-%random%-%random%-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Cryptography /v MachineGuid /t REG_SZ /d PFS-%random%-%random%-%random%-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Windows" "NT\CurrentVersion /v BuildGUID /t REG_SZ /d PFS-%random% /f >Nul 2>&1
    REG ADD HKLM\SOFTWARE\Microsoft\Windows" "NT\CurrentVersion /v InstallDate /t REG_SZ /d %random% /f >Nul 2>&1
    ...
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware" "Profiles\0001 /v GUID /t REG_SZ /d {PFS-%random%-%random%-%random%-%random%} /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware" "Profiles\0001 /v HwProfileGuid /t REG_SZ /d {PFS-%random%-%random%-%random%-%random%} /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\CurrentControlSet\Control\SystemInformation /v ComputerHardwareId /t REG_SZ /d {toxic-s%random%-%random%-%random%-%random%} /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\HardwareConfig /v LastConfig /t REG_SZ /d {eac%random%} /f >Nul 2>&1
    REG ADD HKLM\SYSTEM\HardwareConfig /v LastConfig /t REG_SZ /d {fefefee%random%-%random%-%random%-%random%} /f >Nul 2>&1
    REG ADD HKLM\Software\Microsoft\Windows NT\CurrentVersion /v InstallDate /t REG_SZ /d %random% /f >Nul 2>&1
    REG ADD HKLM\Software\Microsoft\Windows NT\CurrentVersion /v ProductId /t REG_SZ /d %random% /f >Nul 2>&1
    ...
    REG ADD HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion" "WindowsUpdate /v SusClientId /t REG_SZ /d {PFS-%random%-%random%-%random%-%random%} /f >Nul 2>&1
    Start /B POWERSHELL Rename-Computer -NewName "%RANDOM%-PFS-%RANDOM%" >NUL 2>&1
    DEL /F /S /Q "%TEMP%" >Nul 2>&1
    ATTRIB -s -h -r /s /d "C:\USERS\ADMINISTRATOR\APPDATA\ROAMING\Microsoft\Windows\Recent" >Nul 2>&1 & RMDIR /S /Q "C:\USERS\ADMINISTRATOR\APPDATA\ROAMING\Microsoft\Windows\Recent" >Nul 2>&1
    ...
    RMDIR /A /A %systemdrive%\$Recycle.Bin >Nul 2>&1
